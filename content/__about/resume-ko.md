...
<div align="right"><sub><i>Last updated: 2025.04.24</i></sub></div>
...
|    **역할** | DataPipeline 팀 Integration SQD 백엔드 엔지니어  |
| **프로젝트** | Airbridge                               |
...
| -----------: | ----------------------------------------------------- |
|   **기간** | 24.10 ~ 현재                                       |
| **기술스택** | python, kotlin, k8s, AWS, Snowflake                          |
|    **역할** | Postback, 대시보드 API |
